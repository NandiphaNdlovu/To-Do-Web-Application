...
export const NavBar = () => {
    ...
    return (
        <Navbar expand="lg" className={scrolled ? "scrolled" : ""}>
            <Container>
                <Navbar.Brand href="https://nandiphandlovu.github.io/portfolio_website/" className='logo'>
                    <Nav.Link href="https://nandiphandlovu.github.io/portfolio_website/" className={activeLink === 'home' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('home')}>Task Sculpt</Nav.Link>
                </Navbar.Brand>
